    ...
    <body id="main_body" >
        ...
        <div id="form_container">
            <div style="float:center;">
                <img src="imagens/logoPpgArtes.jpg" width="198" height="110" alt="PPGARTES"/>
            </div>
            ...
            <form id="form_cadastrarInscrito" class="appnitro" enctype="multipart/form-data" method="post" action="../processo/processarInscrito.php">
                ...
                <ul >
                    ...
                    <li id="dtNascimento" >
                        ...
                        <span id="calendar_5">
                            <img id="cal_img_5" class="datepicker" src="imagens/calendar.gif" alt="Pick a date.">	
                        </span>
                    ...
                    <li id="EmissorRG" >
                        <label class="description" for="txtEmissorRg">Órgão Expeditor:</label>
                        <div>
                    ...
                    <li id="dtRg" >
                        <label class="description" for="dtRg">Data de Emissão:</label>
                        <span>
                        ...
                        <span id="calendar_8">
                            <img id="cal_img_8" class="datepicker" src="imagens/calendar.gif" alt="Pick a date.">	
                        </span>
                        <script type="text/javascript">
                            Calendar.setup({
                                inputField: "dtRg_3",
                    ...
                    <div id ="dtVisto" style="display: none;" >
                        <li id="dtInicioVigenciaVisto" >
                            <label class="description" for="dtInicioVigenciaVisto">Início Período de Vigência:</label>
                            <span>
                            ...
                            <span id="calendar_22">
                                <img id="cal_img_22" class="datepicker" src="imagens/calendar.gif" alt="Pick a date.">	
                            </span>
                            <script type="text/javascript">
                                Calendar.setup({
                        ...
                        <li id="dtTerminoVigenciaVisto" >
                            <label class="description" for="dtTerminoVigenciaVisto">Término Período de Vigência:</label>
                            <span>
                            ...
                            <span id="calendar_23">
                                <img id="cal_img_23" class="datepicker" src="imagens/calendar.gif" alt="Pick a date.">	
                            </span>
                            <script type="text/javascript">
                                Calendar.setup({
                    ...
                    <li id="Endereço" >
                        <label class="description" for="txtEndereco">Endereço</label>
                        <div>
                    ...
                    <li id="bolAtendimentoEspecial" >
                        <label class="description" for="bolAtendimentoEspecial">Necessita de Atendimento Especial para a realização da prova?
                        </label>
                        <div>
                    ...
                    <li id="LocaldeProva" >
                        <label class="description" for="txtLocaldeProva">Opção de Local/Provas presenciais:</label>
                        <div>
                            <input id="txtLocaldeProva" name="txtLocaldeProva" class="element text medium"  required type="text" maxlength="255" value="PPG BELÉM"/> 
                        </div><p class="guidelines" id="guide_31"><small>Não preencher caso seja no PPGARTES/UFPA (PPG BELÉM)</small></p> 
                    </li>
                    -->		
                    <li id="AutodeclaraçãoDeEtnia" >
                        <label class="description" for="fileAutodeclaraçãoDeEtnia">Autodeclaração de etnia / pessoas trans (item 2.4 e anexo7)</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_15"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>
                    <li id="LaudoMedico" >
                        <label class="description" for="fileLaudoMedico">Laudo Médico (item 2.4)</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_41"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>
                    <li id="ContraCheque" >
                        <label class="description" for="fileContraCheque">Anexar o último contracheque - Vaga PADT (item 2.4)</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_43"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>
                    <li id="NomeEnsinoSuperior" >
                        <label class="description" for="txtNomeEnsinoSuperior">Instituição de Ensino Superior :</label>
                        <div>
                    ...
                    <li id="SiglaEnsinoSuperior" >
                        <label class="SiglaEnsinoSuperior" for="txtSiglaEnsinoSuperior">Sigla da Instituição:</label>
                        <div>
                    ...
                    <li id="Titulo" >
                        <label class="description" for="txtTitulo">Título obtido:</label>
                        <div>
                            <input id="txtTitulo" name="txtTitulo" class="element text medium"  required type="text" maxlength="255" value=""/> 
                        </div> 
                    </li>		
                    <li id="dtInicioCurso" >
                        <label class="description" for="dtInicioCurso">Início do curso:</label>
                        <span>
                        ...
                        <span id="calendar_20">
                            <img id="cal_img_20" class="datepicker" src="imagens/calendar.gif" alt="Pick a date.">	
                        </span>
                        <script type="text/javascript">
                            Calendar.setup({
                    ...
                    <li id="dtTerminoCurso" >
                        <label class="description" for="dtTerminoCurso">Término do curso:</label>
                        <span>
                        ...
                        <span id="calendar_21">
                            <img id="cal_img_21" class="datepicker" src="imagens/calendar.gif" alt="Pick a date.">	
                        </span>
                        <script type="text/javascript">
                            Calendar.setup({
                    ...
                    <li id="TituloProjeto" >
                        <label class="description" for="txtTituloProjeto">Título do Projeto Proposto para o <?php echo $tipoTitulo; ?>:</label>
                        <div>
                            <textarea id="txtTituloProjeto" name="txtTituloProjeto" required class="element textarea medium"></textarea> 
                        </div> 
                    </li>		
                    <li id="optCampo" >
                        <label class="description" for="optCampo">Selecione o Campo de Atuação</label>
                        <div>
                    ...
                    <li  id="Orientador1"  >
                        <label id="Orientador1l" class="description" for="optOrientador1">Orientador(a) (1ª Opção)</label>
                        <div>
                            ...
                            <!--select class="element select medium" required id="optOrientador1" name="optOrientador1" hidden="True"> 
                                <option value="" selected="selected"></option>
                                <option value="1" >LP1 - Ana Flávia Mendes Sapucahy</option>
                                <option value="2" >LP1 - Cesário Augusto de Alencar</option>
                    ...
                    <li id="Orientador2" >
                        <label id="Orientador2l" class="description" for="optOrientador2">Orientador(a) (2ª Opção)</label>
                        <div>
                            ...
                            <!--select class="element select medium" required id="optOrientador2" name="optOrientador2" hidden="True"> 
                                ...
                                <option value="4" >LP1 - Valzeli Figueira Sampaio</option>
                                <option value="5" >LP1 - Orlando Maneschy</option>
                                <option value="6" >LP2 - Ana Cláudia Leão</option>
                    ...
                    <li id="ArquivoDiploma" >
                        ...
                        </div> <p class="guidelines" id="guide_23"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>		
                    <li id="ArquivoHistorico" >
                        <label class="description" for="ArquivoHistorico">Histórico (Conforme subitem 3.2.1.1) :</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_24"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>		
                    <li id="ArquivoRG" >
                        ...
                        </div> <p class="guidelines" id="guide_25"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>		
                    <li id="ArquivoCPF" >
                        ...
                        </div> <p class="guidelines" id="guide_26"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>		
                    <li id="ArquivoGRU" >
                        ...
                        </div> <p class="guidelines" id="guide_27"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>		
                    <li id="ArquivoConcordancia" >
                        <label class="description" for="arquivoConcordancia">Declaração de Concordância (Conforme subitem 3.2.1.4)</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_28"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>
                    <!--
                    RETIRADO NO PSPPGARTES 2021		
                    <li id="ArquivoAnuencia" >
                        <label class="description" for="arquivoAnuencia">Declaração de Anuência (Conforme subitem 3.2.1.5)</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_29"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>
                    --> 		
                    <li id="ArquivoProficiencia" >
                        <label class="description" for="element_30">Comprovante 1 de proficiência em língua estrangeira  (Conforme subitem 3.2.1.6)</label>
                        <div>
                        ...
                        </div> <p class="guidelines" id="guide_30"><small>Obrigatório que esteja no formato PDF</small></p> 
                    </li>
                    <?php
                    ...
                    if ($tipoinscrito == '2')
                        ...
                        "<label class='description' for='element_30'>Comprovante 2 de proficiência em língua estrangeira  (Conforme subitem 3.2.1.6)</label> " .
                        "<div>" .
                        ...
                        "</div> <p class='guidelines' id='guide_32'><small>Obrigatório que esteja no formato PDF</small></p>" .
                        "</li>";
                        }
                    ?>
                    <li id="VinculoEmpregaticio" >
                        <label class="description" for="bolVinculoEmpregaticio">Vínculo Empregatício:</label>
                        <div>
