	...
	//for ($i = $start; $i < $end; $i++)
        while ($row = mysqli_fetch_array($result) )
        {
               ...
               // antigo if ($i == $total_results) { break; }
				...
				echo "<td> <a href='homologarDoutorado.php?estadoHomologacao=1&idCandidato=$idCandidato&idProcesso=$idProcesso&page=$pg'>Sim</a> / <a href='homologarMestrado.php?estadoHomologacao=2&idCandidato=$idCandidato&idProcesso=$idProcesso&page=$pg'>Não</a></td>";                                
		                echo "</tr>";
        }   ?>
