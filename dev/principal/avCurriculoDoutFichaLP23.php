        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('.calc').change(function () {
                    ...
                    var total = item1 + item2 + item3 + item4 + item5 + item6 + item8 + item9 + item10;
                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/pontuacaoCurriculo.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>&idTipo=1"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <!--tr>
                                                        <td align="left">2.4- Premiação de projetos de pesquisa, extensão</td>
                                                        <td>0.00 - 1.00</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left">3.1- Atuação em eventos acadêmicos e culturais na área .</td>
                                                        <td>0.00 - 1.00</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left"><b> 4. MEMORIAL OU PORTFÓLIO</b></td>
                                                        <td></td>  
                                                        <td></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">4.2- Memorial</td>
                                                        <td>0.00 - 2.00</td>  
