...
if ($idTipo != 3)
    {
    //echo "<td></td>";
    echo "<td><b><a href='cadastrarCandidatoMestrado.php?idProcesso=$idProcesso&idTipo=1'>Cadastro de Candidatos</a></b><br /><a href='../relatorios/relatorioCandidatosInscritosMestrado.php?idProcesso=$idProcesso&idTipo=1' target='_blank'>Relatório de inscritos</a></td>";
    }
echo "</tr>";
//Fase 3
echo "<tr>";
...
if ($idTipo != 3)
    ...
    echo "<td><b><a href='homologacaoMestrado.php?idProcesso=$idProcesso&idTipo=1'>Homologar</a><br /></b>";
    echo "<a href = '../relatorios/relatorioHomologacaoMestradoPublico.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'>Relatório de Homologação</a>";
    ...
    echo "<br /><a href = '../relatorios/relatorioInscricoesHomologadasMestrado.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'>Relatório de Inscrições Homologadas</a>";
...
if ($idTipo != 3)
    ...
    echo "<a href = '../relatorios/relatorioProjetoNotas.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'> Relatório de Candidatos e Notas do Projeto</a>";
    }
echo "</td></tr>";
...
/*
  ...
  */
  ...
  echo "<td>13/05/2021 a 21/05/2021</td>";
  echo "<td>";
  if ($idTipo != 3) {
  ...
  echo "<a href = '../relatorios/relatorioCurriculoNotas.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'> Relatório de Candidatos e Notas do Currículo</a>";
  } else {
  ...
  echo "<td>";
  if ($idTipo != 3) {
  echo "<a href = 'relatorioAlocacaoEntrevistaMest.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'> Relatório de Professores  Alocados</a><br />";
  echo "<a href = '../relatorios/relatorioEntrevistaNotas.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'> Relatório de Candidatos e Notas da Entrevista</a>";
  } else {
