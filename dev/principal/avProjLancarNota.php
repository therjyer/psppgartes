                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/notaProjeto.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">1. Relação do Anteprojeto com a atuação acadêmica, artística e cultural dos orientadores disponíveis, e às linhas de pesquisa do Programa. </td>
                                                        <td>0.00 - 3.00</td>
                                                        <td> <input type="number" id="item1" name="item1" class="calc" min="0.00" max="3.00" step ="0.01" size=200 required=""></td>                
                                                    </tr>

                                                    <tr>
                                                        <td align="left">2. Aspectos teóricos, práticos, conceituais e metodológicos em consonância com as linhas de pesquisa do Programa.</td>
                                                        <td>0.00 - 3.00</td>
                                                        <td> <input type="number" id="item2" name="item2" class="calc" min="0.00" max="3.00" step ="0.01" size=200 required=""></td>                
                                                    </tr>            

                                                    <tr>
                                                        <td align="left"> 3. Viabilidade da Pesquisa</td>
                                                        <td>0.00 - 3.00</td>  
                                                        <td><input type="number" id="item3" name="item3" class="calc" min="0.00" max="3.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
