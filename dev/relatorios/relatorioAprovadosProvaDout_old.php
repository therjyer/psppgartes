...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.linhaPesquisa, c.cpf, c.notaProva1, c.notaProva2 from candidato c WHERE c.processo = $idProcesso AND c.estado=1 AND c.estadoHomologacao = 1 AND c.tipoProcesso=2 ORDER BY c.linhaPesquisa");
