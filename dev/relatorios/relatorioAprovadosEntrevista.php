...
$pdf->Ln();
    ...
    $result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf,c.linhaPesquisa, c.pontuacaoCurriculo, c.notaEntrevista FROM candidato c WHERE c.cotas in ('cc','cct') AND c.processo = $idProcesso AND c.estadoHomologacao=1 AND c.estado=1 AND (c.pontuacaoCurriculo >=7) AND (c.notaEntrevista >=7) AND c.tipoProcesso=$idTipoProcesso ORDER BY  c.linhaPesquisa, c.pontuacaoCurriculo DESC");
