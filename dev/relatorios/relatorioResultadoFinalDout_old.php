...
FROM candidato c WHERE  c.processo = 44 AND c.estadoHomologacao=1 AND c.estado=1 AND c.tipoProcesso = 2 AND c.notaEntrevista>=7 AND c.cotas = 'ac' ORDER BY c.linhaPesquisa, notaFinalCalc DESC, notaAnteprojeto DESC");
...
//$result = mysqli_query($_SG['link'], "SELECT c.idCandidato, c.nome, c.numInscricao, c.linhaPesquisa, c.cpf, c.notaEntrevista, c.notaProva1, c.notaProva2, c.notaAnteprojeto1, c.notaAnteprojeto2, c.notaEntrevista, c.notaProfile, c.pontuacaoCurriculo, c.notaFinal FROM candidato c WHERE  c.processo = $idProcesso AND c.estadoHomologacao=1 AND c.estado=1 AND c.tipoProcesso = 2 AND c.notaEntrevista>=7 AND c.cotas = 'ac' ORDER BY c.linhaPesquisa, c.notaFinal DESC ");
$result = mysqli_query($_SG['link'], "SELECT  c.idCandidato, c.nome, c.linhaPesquisa,  ((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) AS notaAnteprojeto, ((c.notaProva1+c.notaProva2)/2) AS notaProva , c.pontuacaoCurriculo, c.notaEntrevista , c.notaFinal, (((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) +  ((c.notaProva1+c.notaProva2)/2) + c.pontuacaoCurriculo + c.notaEntrevista) AS notaFinalCalc
FROM candidato c WHERE  c.processo = 44 AND c.estadoHomologacao=1 AND c.estado=1 AND c.tipoProcesso = 2 AND c.notaEntrevista>=7 AND c.cotas = 'er' ORDER BY c.linhaPesquisa, notaFinalCalc DESC, notaAnteprojeto DESC");
...
$result = mysqli_query($_SG['link'], "SELECT  c.idCandidato, c.nome, c.linhaPesquisa,  ((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) AS notaAnteprojeto, ((c.notaProva1+c.notaProva2)/2) AS notaProva , c.pontuacaoCurriculo, c.notaEntrevista , c.notaFinal, (((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) +  ((c.notaProva1+c.notaProva2)/2) + c.pontuacaoCurriculo + c.notaEntrevista) AS notaFinalCalc
FROM candidato c WHERE  c.processo = 44 AND c.estadoHomologacao=1 AND c.estado=1 AND c.tipoProcesso = 2 AND c.notaEntrevista>=7 AND c.cotas = 'padt' ORDER BY c.linhaPesquisa, notaFinalCalc DESC, notaAnteprojeto DESC");
