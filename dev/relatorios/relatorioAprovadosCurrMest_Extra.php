...
$pdf->SetFont('arial', 'B', 9);
$pdf->setXY(1.7, 3.4);
$pdf->Cell(17.5, 0.6, 'Classificação Geral', 1, 1, "C");
...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf,c.linhaPesquisa, c.pontuacaoCurriculo FROM candidato c WHERE  c.processo = $idProcesso AND c.estadoHomologacao=1 AND c.estado=1 AND (c.pontuacaoCurriculo >=7) AND c.tipoProcesso=1 ORDER BY  c.linhaPesquisa, c.pontuacaoCurriculo DESC");
...
$pdf->Output("relatorioAprovadosCurrMest_Geral.pdf", "I");
?>
