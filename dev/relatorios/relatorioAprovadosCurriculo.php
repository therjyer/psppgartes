...
$pdf->Ln();
       ...
       $pdf->setX(1.7);
        ...
        $pdf->Cell(17.5, 0.6, 'ETNORACIAL e/ou PcD', 1, 1, "C");
    $pdf->SetFont('arial', 'B', 9);
    $pdf->setX(1.7);
    $pdf->Cell(9.5, 0.6, 'Nome do candidato', 1, 0, "C");
    $pdf->Cell(4, 0.6, 'Nota', 1, 0, "C");
    ...
    $result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf,c.linhaPesquisa, c.pontuacaoCurriculo FROM candidato c WHERE c.cotas in ('cc','cct') AND c.processo = $idProcesso AND c.estadoHomologacao=1 AND c.estado=1 AND (c.pontuacaoCurriculo >=7) AND c.tipoProcesso=$idTipoProcesso ORDER BY  c.linhaPesquisa, c.pontuacaoCurriculo DESC");
