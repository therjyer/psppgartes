...
FROM candidato c WHERE  c.processo = 45 AND c.estadoHomologacao=1 AND c.estado=1 AND c.tipoProcesso = 2 AND c.resultadoFinal = 1 ORDER BY notaFinalCalc DESC, notaAnteprojeto DESC, notaProva DESC");
...
$pdf->Output("Relatório Geral Classificados - DOUTORADO (Processo Seletivo " . $processo . ").pdf", "I");
?>