        ...
        <div id="form_container">
            ...
            <form id="form_98277" class="appnitro"  method="post" action="">
                <div class="form_description">
                    <h2>PSPPGARTES</h2>
                    <p>Formulário de Solicitação de Inscrição - Edital 2023 - <? php echo $tipoTitulo ?></p>
                </div>						
                <ul >
                    ...
                    // #2023 $conn = mysqli_connect('localhost', 'u613711144_psppgdev', ':2!2g6G#', 'u613711144_psppgdev');
                    ...
                    if ($data['TOTAL'] !== "0") {
                        die("O CPF '$txtCPF' já foi cadastrado para o PSPPGARTES 2023<p><a href='http://www.ppgartes.propesp.ufpa.br/'>www.ppgartes.propesp.ufpa.br</a></p>");
                    }
                    ...
                    foreach ($_FILES["Anexos"]["error"] as $key => $error) {
                        if ($error == UPLOAD_ERR_OK) {
                            ...
                            $linkemail = "https://psppgartes.4gestor.net/up2023/" . $name_target;
                            
                            $linkemail = "<a href = 'https://psppgartes.4gestor.net/up2023/$name_target' target = '_blank'>$name</a>";
                            
                            $countArquivo = $countArquivo + 1;
                            //$name_target = $txtCPF . '_' . $name; //até 2021 com o nome que poderia ter acentos
                            //echo $name_target . '<br />';

                            move_uploaded_file($tmp_name, "../up2023/$name_target");
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
                    $mail->Subject = "PSPPGARTES2023 " . $tipoTitulo . " - " . $txtNome; // Assunto da mensagem
//$mail->Body
                    ...
                    $textoEmail = "<p>Novo Cadastro no Sistema do Processo Seletivo do PPGARTES - 2023.</p>" .
...
//EMAIL DO INSCRITO
                    ...
                    $mail->AddBCC('alexmota.br@gmail.com', 'Alexandre PPGARTES');
                    $mail->Subject = "PSPPGARTES2023 - Confirmação de Inscrição de " . $txtNome; // Assunto da mensagem
