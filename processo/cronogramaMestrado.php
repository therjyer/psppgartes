...
/*
  ...
  */
  ...
  echo "<td>";
  if ($idTipo != 3) {
  echo "<b><a href = 'relatorioResultadoFinalMest.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'>Relatório Final para Publica��o</a></b><br />";
  echo "<a href = 'relatorioResultadoFinalAreaMest.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'>Relatório Extra por �rea</a><br />";
  echo "<a href = 'relatorioResultadoFinalMestExtra.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'>Relatório Extra - Classificados (Bolsas)</a><br />";
  }
  echo "</td>";
  echo "</tr>";
