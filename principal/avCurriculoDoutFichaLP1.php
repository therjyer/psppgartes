                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/pontuacaoCurriculo.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>&idTipo=1"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">1.2 - Formação continuada: participação como ouvinte em eventos acadêmicos, artísticos e culturais na área de artes (cursos de extensão, seminários, congressos e similares). 0,20 pto. por evento de no mínimo 20 horas</td>
                                                        <td>0.00 - 1.00</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left">2.3 - Publicações: livro de artista; capítulo de livro, catálogo, ensaio, entrevista, edição ou organização em veículos com ISBN ou ISSN, impresso ou on-line na área de artes .</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item6" name="item6" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.4 - Participação em Projetos Acadêmicos com integrante da equipe de trabalho: Iniciação Científica; Programa/Projeto de Ensino, Extensão; Projeto Artístico; Projeto Cultural.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item7" name="item7" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.5- Premiação na área de Artes.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item8" name="item7" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left"><b> 3. PORTFÓLIO</b></td>
                                                        <td></td>  
                                                        <td></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">3.1 - Aspectos artísticos-culturais e conceituais do Portfólio, assim como a relevância do impacto da obra, a repercussão e a abrangência no sistema das artes.</td>
                                                        <td>0.00 - 2.00</td>  
