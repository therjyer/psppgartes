                    ...
                    <div id="tab-data-wrap">
                            ...
                            <section class="clearfix">
                                <div class="g3">
                                    <div>
                                        <div class="info">
                                            <h4>
                                                Doutorado - Lista de candidatos inscritos no processo de seleção <?php echo $processo; ?>
                                            </h4>

                                        </div>

                                        <div align="center">
                                            <form class="form-wrapper cf" method="post" action="candidatosDoutorado.php?idProcesso=<?php echo $idProcesso; ?>">
                     ...
                     ";
                                        ...
                                        <div align='center'>                               <p>
                                                ...
                                                $result = mysqli_query($_SG['link'], "SELECT c.estado, c.idCandidato, c.tipoProcesso, c.numInscricao, c.nome FROM candidato c WHERE  (c.nome like '%$busca%' OR c.cpf like '%$busca%' OR c.numInscricao like '%$busca%') AND c.estado = 1 AND c.processo = '$idProcesso' AND c.tipoProcesso = 2 ORDER BY c.nome")
                                                        or die(mysql_error());
                                                ...
                                                for ($i = 1; $i <= $total_pages; $i++) {
                                                    if ($pg_atual > 0)
                                                        ...
                                                        if ($i == $pg_atual)
                                                            {
                                                            echo "<li ><a class='current' href='candidatosDoutorado.php?page=$i&idProcesso=$idProcesso'> $i </a></li>";
                                                            } else
                                                            {
                                                            echo "<li><a href='candidatosDoutorado.php?page=$i&idProcesso=$idProcesso'> $i </a></li>";
                                                            }
                                                        } else
                                                        {
                                                        echo "<li ><a class='current' href='candidatosDoutorado.php?page=1&idProcesso=$idProcesso'> 1 </a></li>";
                                                        $pg_atual = 1;
                                                        }
                                                }
