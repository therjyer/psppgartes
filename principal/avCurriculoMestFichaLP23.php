                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/pontuacaoCurriculo.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>&idTipo=1"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">1.1- Curso superior na área de artes (caso não tenha esse item, avaliar o item 1.1.1 e 1.1.2).</td>
                                                        <td>0.00 - 2.00</td>  
                                                        <td><input type="number" id="item1" name="item1" class="calc" min="0" max="2.00" step ="0.01" size=90 onblur="bloqueia1();" required></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">1.1.1 - 1.1.1	Curso superior em quaisquer outras áreas; 1.1.2	- Comprovação de atuação, dos cinco últimos anos, na área de artes </td>
                                                        <td>0.00 - 2.00</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left">2.1- Atuação na área de artes como: artista, técnico, produtor, curador, pesquisador, educador, autônomo e/ou funcionário de instituições culturais e/ou educacionais, públicas ou privadas</td>
                                                        <td>0.00 - 1.50</td>  
                                                        <td><input type="number" id="item4" name="item4" class="calc" min="0" max="1.50" step ="0.01" size=90 required=""></td>   
                                                    </tr>

                                                    <tr>
                                                        <td align="left">2.2- Atuação em eventos acadêmicos, artísticos e culturais na área (expositor, curador, palestrante, comunicador, ministrante em cursos de extensão, congressos e similares). 0.25 pto. por cada atuação</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item5" name="item5" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.3- Participação em Projetos Acadêmicos: Iniciação Científica;Programa/Projeto de Ensino, Extensão;Projeto Artístico; Projeto Cultural</td>
                                                        <td>0.00 - 1.50</td>  
                                                        <td><input type="number" id="item6" name="item6" class="calc" min="0" max="1.50" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.4- Premiação na área de Artes. 0,50 por cada prêmio recebido</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item7" name="item7" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left"><b>3. MEMORIAL</b></td>
                                                        <td></td>  
                                                        <td></td>   
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="left">3.2- Produções bibiográficas.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item9" name="item8" class="calc" min="0" max="2.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <!-- TOTAL -->
                                                    <tr>
                                                        <td> <b>Total</b></td>
