                            ...
                            <section class="clearfix">
                                <div class="g3">
                                    ...
                                    <!-- LP 2 e 3 -->
                                                    ...
                                                    <tr>
                                                        <td align="left">2.3- Projetos Desenvolvidos- (Pesquisa; Educacional; Extensão, dentre outros), 
                                                                         015 pontos por cada atuação.</td>
                                                        <td>0.00 - 1.50</td>  
                                                        <td><input type="number" id="item6" name="item6" class="calc" min="0" max="1.50" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                                                                        <tr>
                                                        <td align="left">2.4- Premiação ? 0,20 por Premiação de projetos pesquisa e extensão, dentre outros.</td>
                                                        <td>0.00 - 1.00</td>  
