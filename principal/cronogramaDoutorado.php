...
if ($idTipo != 3)
    {
    echo "<td><a href='../relatorios/relatorioCandidatosInscritosDoutorado.php?idProcesso=$idProcesso&idTipo=2' target='_blank'>Relatório de inscritos</a>";
    //2024 sem cadastro echo "<td><b><a href='cadastrarCandidatoDoutorado.php?idProcesso=$idProcesso&idTipo=2'>Cadastro de Candidatos</a></b><br /><a href='../relatorios/relatorioCandidatosInscritosDoutorado.php?idProcesso=$idProcesso&idTipo=2' target='_blank'>Relatório de inscritos</a></td>";
    //echo "<td><b><a href='homologacaoDoutorado.php?idProcesso=$idProcesso&idTipo=2'>Homologar</a><br /></b></td>";
    echo "<br /><b><a href='homologacaoDoutorado.php?idProcesso=$idProcesso&idTipo=2'>Homologar</a><br /></b>";
    echo "<a href = '../relatorios/relatorioHomologacaoDoutoradoPublicoJustificativa.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório de Homologação Justificativa</a>";
    echo "<br /><a href = '../relatorios/relatorioHomologacaoDoutoradoPublico.php?idProcesso=$idProcesso&idTipo=1' target = '_blank'>Relatório de Homologação</a>";
    ...
    echo "<br /><b><a href = '../relatorios/relatorioInscricoesHomologadasDoutorado.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório de Inscrições Homologadas</b></a>";
    ...
    echo "<br /><a href = '../relatorios/relatorioCotas.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório de Inscrições Homologadas por Cota</a>";
...
if ($idTipo != 3)
    ...
    echo "<a href = '../relatorios/relatorioProjetoNotas.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório de Candidatos e Notas do Projeto</a><br />";
...
/*
  ...
  echo "<td>";
  if ($idTipo != 3) {
  echo "<a href = 'relatorioAlocacaoProvaMest.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório de Aloca��o</a><br />";
  echo "<a href='relatorioProvaMest_cpf.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório Extra por CPF</a><br /></b>";
  echo "<a href = 'relatorioProvaMest_nome.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório Extra por Nome</a>";
  } else {
  ...
  echo "<td>";
  if ($idTipo != 3) {
  echo "<b><a href = 'relatorioAprovadosProvaMest.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório para Publica��o</a></b><br />";
  echo "<a href = 'relatorioAprovadosProvaMest_linha.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório Extra por Nome, Linha e Campo</a><br />";
  echo "<a href = 'relatorioAprovadosProvaMest_nome.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório Extra por Ordem Alfab�tica</a>";
  }
  echo "</td></tr>";
  */
  //Fase 3
  ...
  echo "<a href = '../relatorios/relatorioCurriculoNotas.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório de Candidatos e Notas do Currículo</a><br />";
  } else {
  echo "<b><a href = 'avaliarCurriculo.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Lançar Nota Currículo</a></b><br />";
  }
  ...
  //echo "<a href = '../relatorios/relatorioAprovadosCurrMest_linha.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório Extra por Nome, Linha e Campo</a><br />";
  //echo "<a href = '../relatorios/relatorioAprovadosCurrMest_nome.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório Extra por Ordem Alfab�tica</a><br />";
  //echo "<a href = '../relatorios/relatorioAprovadosCurrMest_Extra.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'>Relatório Extra de Classifica��o Geral</a>";
  }
  echo "</td>";
  echo "</tr>";
  ...
  echo "<td>";
  if ($idTipo != 3) {
  echo "<a href = '../relatorios/relatorioAlocacaoEntrevistaDout.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório de Professores  Alocados</a><br />";
  echo "<a href = '../relatorios/relatorioEntrevistaNotas.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório de Candidatos e Notas da Entrevista</a><br />";
  } else {
  ...
  echo "<a href = '../relatorios/relatorioAndamentoAteEntrevista.php?idProcesso=$idProcesso&idTipo=2' target = '_blank'> Relatório de Andamento Até Etapa Entrevista</a><br />";
  }
  echo "</td>";
  echo "</tr>";
