                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/pontuacaoCurriculo.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>&idTipo=1"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">2.2- Atuação em eventos acadêmicos, artísticos e culturais na área (expositor, curador, palestrante, comunicador, ministrante em cursos de extensão, congressos e similares). 0.20 pto. por cada atuação</td>
                                                        <td>0.00 - 1.00</td>  
