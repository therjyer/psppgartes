                        ...
                        <div id="usuarios">
                            <section class="clearfix">
                                <div class="g3">
                                    ...
                                    <!-- TODOS -->                        
                                                    <tr>
                                                        <td align="left">1. FORMAÇÃO (Os candidatos serão pontuados no subitem 1.1 ou 1.2) </td>
                                                        <td></td>
                                                        <td> </td>                
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="left">1.2- Curso superior em quaisquer outras áreas (2 pto.) e curso técnico (nível médio) na área de artes (1 pto.) ou comprovação de atuação, de três anos, na área de artes. (1 pto.)</td>
                                                        <td>0.00 - 2.00</td>  
...
<!--
                                    ...
                                    <!-- LP 1 -->
                                                    ...
                                                    <tr>
                                                        <td align="left">2.1- Atuação na área de artes como artista, 
                                                            produtor, técnico, e/ou funcionário/membro de instituições culturais 
                                                            públicas ou privadas. 0.20 pto. por cada atuaçã.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item4" name="item4" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
  
                                                    <tr>
                                                        <td align="left">2.2- Projetos Desenvolvidos- (Pesquisa Artística de Produção 
                                                            artística e ou produção técnica; conforme definido no item 8.3.3. do edital.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item5" name="item5" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.3- Premiação ? 0,20 por Premiação de projetos artísticos,
                                                    ...
                                                    <tr>
                                                        <td align="left">3.1- Atuação em eventos científico-culturais na área 
                                                            (palestrante, comunicador ou ministrante em cursos de extensão, congressos e similares). 
                                                            0.20 pto. por cada atuação. Conforme o Anexo 5.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item7" name="item7" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">3.2- Publicação de livro, capítulo, artigo, ensaio, entrevista, tradução, 
                                                            edição ou organização em veículos com ISBN ou ISSN, impresso ou online. 
                                                            0.20 pto. por cada publicação. Conforme o Anexo 5.</td>
                                                        <td>0.00 - 1.00</td>  
