                                    ...
                                    <!-- LP 1 -->
                                                    ...
                                                    <tr>
                                                        <td align="left">2.1- Atuação na área de artes como pesquisador ou educador, como autônomo 
                                                                            e/ou funcionário/membro de instituições culturais e educacionais, 
                                                                            públicas ou privadas, 0.20 pto. por cada atuação.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item4" name="item4" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
  
                                                    <tr>
                                                        <td align="left">2.2- Projetos Desenvolvidos- (Pesquisa; Educacional; Extensão, dentre outros).</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item5" name="item5" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.3- Premiação 0,20 por Premiação de projetos pesquisa e extensão</td>
                                                        <td>0.00 - 1.00</td>  
