                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/pontuacaoCurriculo.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>&idTipo=1"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">1.1.1 - Curso superior em quaiquer outras áreas; 1.1.2	- Comprovação de atuação, dos cinco últimos anos, na área de artes</td>
                                                        <td>0.00 - 2.00</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left">2.3- Participação em Projetos Acadêmicos com integrante de equipe: Iniciação Científica; Programa/Projeto de Ensino, Extensão; Projeto Artístico; Projeto Cultural .</td>
                                                        <td>0.00 - 1.50</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left">3.1 - Aspectos artístico-culturais e conceituais do Portfólio, assim como a relevância do impacto da(s) obra(s), a repercussão e a abrangência no sistema das Arte.</td>
                                                        <td>0.00 - 2.00</td>  
