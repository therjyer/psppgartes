        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('.calc').change(function () {
                    ...
                    //O total é o número de item x o valor de x
                            ...
                            <section class="clearfix">
                                <div class="g3">
                                    <div>
                                        <div class="info">
                                            <h4>
                                                Ficha de Avaliação da Prova de Títulos - Mestrado
                                            </h4>
                                        </div>
                                    ...
                                    <!-- TODOS -->                        
                                                    ...
                                                    <tr>
                                                        <td align="left">1.1- Curso superior na área de artes.</td>
                                                        <td>0.00 - 2.00</td>  
                                                        <td><input type="number" id="item1" name="item1" class="calc" min="0" max="2.00" step ="0.01" size=90 onblur="bloqueia1();" required></td>   
                                                    </tr>

                                                    <tr>
                                                        <td align="left">1.2- Curso superior em quaisquer outras áreas e um curso técnico (nível médio) na área de artes ou comprovação de atuação, de três anos, na área de artes.</td>
                                                        <td>0.00 - 2.00</td>  
                                                        <td><input type="number" id="item2" name="item2" class="calc" min="0" max="2.00" step ="0.01" size=90 onblur="bloqueia2();" required></td>   
                                                    </tr>

                                                    <tr>
                                                        <td align="left">1.3- Formação continuada: Participação como ouvinte em eventos científicos na área de artes (cursos de extensão, seminários, congressos e similares). 0,15 pto. por evento de no mínimo 20 horas. (Máximo 1 pto.) </td>
                                                        <td>0.00 - 1.00</td>  
                                    ...
                                    <!-- LP 1 -->
                                                    ...
                                                    <tr>
                                                        <td align="left">2.1- Atuação na área de artes como artista, produtor, técnico,
                                                            e/ou funcionário/membro de instituições
                                                            culturais públicas ou privadas. 0.15 pto. por cada atuação.</td>
                                                        <td>0.00 - 1.50</td>  
                                                        <td><input type="number" id="item4" name="item4" class="calc" min="0" max="1.50" step ="0.01" size=90 required=""></td>   
                                                    </tr>
  
                                                    <tr>
                                                        <td align="left">2.2- Atuação em eventos científico-culturais na área
                                                            (palestrante, comunicador ou ministrante em cursos de extensão, 
                                                            congressos e similares). 0.20 pto. por cada atuação. Conforme o Anexo 5.</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item5" name="item5" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">2.3- Projetos Desenvolvidos - (Pesquisa Artística de Produção artística
                                                            e ou produção técnica; 0.15 pto. Por projeto. Conforme definido no item 8.3.3. do edital</td>
                                                        <td>0.00 - 1.50</td>  
                                                        <td><input type="number" id="item6" name="item6" class="calc" min="0" max="1.50" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                                                                        <tr>
                                                        <td align="left">2.4- Premiação ? 0,20 por Premiação de projetos artísticos,
                                                    ...
                                                    <tr>
                                                        <td align="left"><b> 3. PORTFOLIO (LP1 exclusivamente)</b></td>
                                                        <td></td>  
                                                        <td></td>   
                                                    </tr>
                                                    <tr>
                                                        <td align="left">3.1- Portfólio .</td>
                                                        <td>0.00 - 2.00</td>  
                                    ...
                                    <!-- LP 2 e 3 -->
                                                    ...
                                                    <tr>
                                                        <td align="left">2.1- Atuação na área de artes como pesquisador ou educador, como autônomo 
                                                                        e/ou funcionário/membro de instituições culturais e educacionais, públicas
                                                                        ou privadas, 0.15 pto. por cada atuação.</td>
                                                        <td>0.00 - 1.50</td>  
                                                        <td><input type="number" id="item9" name="item9" class="calc" min="0" max="1.50" step ="0.01" size=90 required=""></td>   
                                                    </tr>
