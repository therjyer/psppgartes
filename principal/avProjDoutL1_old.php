                            ...
                            <section class="clearfix">
                                <div class="g3">
                                    <div>
                                        <div class="info">
                                            <h4>
                                                Ficha 01 - Avalia��o do Anteprojeto de Pesquisa - Doutorado
                                            </h4>
                                        </div>
                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/notaProjeto.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">1. Relação do Projeto com a atuação dos orientadores disponíveis, e às linhas de pesquisa do Programa. </td>
                                                        <td>0.00 - 3.00</td>
                                                        <td> <input type="number" id="item1" name="item1" class="calc" min="0.00" max="3.00" step ="0.01" size=200 required=""></td>                
                                                    </tr>

                                                    <tr>
                                                        <td align="left">2. Aspectos teóricos, práticos, conceituais e metodológicos.</td>
                                                        <td>0.00 - 3.00</td>
