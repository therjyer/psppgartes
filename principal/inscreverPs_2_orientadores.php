        ...
        <div id="form_container">
            ...
            <form id="form_cadastrarInscrito" class="appnitro" enctype="multipart/form-data" method="post" action="../processo/processarInscrito.php">
                ...
                <ul >
                    ...
                    <li id="dtNascimento" >
                        <label class="description" for="dtNascimento">Data de Nascimento:<span class="required">*</span>
                        </label>
                        <span>
                    ...
                    <li id="dtRg" >
                        <label class="description" for="dtRg">Data de Emissão:<span class="required">*</span></label>
                        <span>
                    ...
                    <div id ="dtVisto" style="display: none;" >
                        ...
                        <li id="dtTerminoVigenciaVisto" >
                            <label class="description" for="dtTerminoVigenciaVisto">Término Periodo de Vigência:</label>
                            <span>
                    ...
                    <li id="bolAtendimentoEspecial" >
                        <label class="description" for="bolAtendimentoEspecial">Necessita de Atendimento Especial para a realização da prova?<span class="required">*</span>
                        </label>
                        <div>
                    ...
                    <li id="LocaldeProva" >
                        ...
                        </div><p class="guidelines" id="guide_31"><small>Não preencher caso seja no PPGARTES/UFPA (PPG BEL�M)</small></p> 
                    </li>
                    -->		
                    <li id="AutodeclaraçãoDeEtnia" >
                        <label class="description" for="fileAutodeclaraçãoDeEtnia">Autodeclaração de etnia / pessoas trans (item 2.4 e anexo 6)</label>
                        <div>
                    ...
                    <li id="dtInicioCurso" >
                        <label class="description" for="dtInicioCurso">Início do curso:<span class="required">*</span></label>
                        <span>
                    ...
                    <li id="optLinhaPesquisa" >
                        <label class="description" for="optLinhaPesquisa">Selecione sua linha de pesquisa:<span class="required">*</span></label>
                        <div>
                    ...
                    <li  id="Orientador1"  >
                        <label id="Orientador1l" class="description" for="optOrientador1">Orientador(a) (1ª Opção)<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoDiploma" >
                        <label class="description" for="arquivoDiploma">Diploma (Conforme subitem 3.2.1.2):<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoHistorico" >
                        <label class="description" for="ArquivoHistorico">Histórico (Conforme subitem 3.2.1.2):<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoRG" >
                        <label class="description" for="arquivoRg">RG (Conforme subitem 3.2.1.3):<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoCPF" >
                        <label class="description" for="arquivoCpf">CPF (Conforme subitem 3.2.1.3):<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoGRU" >
                        <label class="description" for="arquivoGru">GRU e Comprovante de Pagamento (Conforme subitem 3.2.1.3):<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoConcordancia" >
                        <label class="description" for="arquivoConcordancia">Declaração de Concordância (Conforme subitem 3.2.1.4):<span class="required">*</span></label>
                        <div>
                    ...
                    <li id="ArquivoAnuencia" >
                        <label class="description" for="arquivoAnuencia">Declaração de Anu�ncia (Conforme subitem 3.2.1.5)</label>
                        <div>
                    ...
                    <li id="ArquivoProficiencia" >
                        <label class="description" for="element_30">Comprovante 1 de proficiência em língua estrangeira  (Conforme subitem 3.2.1.5)</label>
                        <div>
                    ...
                    if ($tipoinscrito == '2')
                        ...
                        "<label class='description' for='element_30'>Comprovante 2 de proficiência em lígua estrangeira  (Conforme subitem 3.2.1.6)</label> " .
                        "<div>" .
                    ...
                    <li id="VinculoEmpregaticio" >
                        <label class="description" for="bolVinculoEmpregaticio">Vínculo Empregatício:<span class="required">*</span></label>
                        <div>
