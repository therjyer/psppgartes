                            ...
                            <section class="clearfix">
                                <div class="g3">
                                    <div>
                                        <div class="info">
                                            <h4>
                                                Ficha de Avaliação do Projeto - Mestrado
                                            </h4>
                                        </div>
                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/notaProjeto.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">1. Relação do Anteprojeto com a linha de pesquisa pretendida. </td>
                                                        <td>0.00 - 2.50</td>
                                                        <td> <input type="number" id="item1" name="item1" class="calc" min="0.00" max="2.50" step ="0.01" size=200 required=""></td>                
                                                    </tr>

                                                    <tr>
                                                        <td align="left">2. Relevância do problema à delimitação em relação com os objetivos da pesquisa. </td>
                                                        <td>0.00 - 2.50</td>
                                                        <td> <input type="number" id="item2" name="item2" class="calc" min="0.00" max="2.50" step ="0.01" size=200 required=""></td>                
                                                    </tr>            
