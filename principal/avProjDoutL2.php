                            ...
                            <section class="clearfix">
                                <div class="g3">
                                    <div>
                                        <div class="info">
                                            <h4>
                                                Ficha 3.2.2 - FICHA DE ANÁLISE DO CURRÍCULO/PORTFÓLIO/MEMORIAL - Doutorado - LP2
                                            </h4>
                                        </div>
                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/notaProjeto.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left"> 3. Produção Escrita.</td>
                                                        <td>0.00 - 2.00</td>  
                                                        <td><input type="number" id="item3" name="item3" class="calc" min="0.00" max="2.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>

                                                    <tr>
                                                        <td align="left">4. Memorial ou Portfolio.</td>
                                                        <td>0.00 - 2.00</td>  
                                                        <td><input type="number" id="item4" name="item4" class="calc" min="0.00" max="2.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
