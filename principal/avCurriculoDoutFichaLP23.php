                                        ...
                                        <div align="center">
                                            ...
                                            <form  id="avProva" name="avProva" method="post"  action="../processo/pontuacaoCurriculo.php?idCandidato=<?php echo $idCandidato; ?>&idProcesso=<?php echo $idProcesso; ?>&idProfessor=<?php echo $idProfessor; ?>&idTipo=1"  >
                                                ...
                                                <table id="rounded-corner">
                                                    ...
                                                    <tr>
                                                        <td align="left">2.3- Participação em Projetos Acadêmicos como integrante da equipe de trabalho, bolsista ou bolsista voluntário, 0.25 pto por cada atuação</td>
                                                        <td>0.00 - 1.00</td>  
                                                        <td><input type="number" id="item6" name="item6" class="calc" min="0" max="1.00" step ="0.01" size=90 required=""></td>   
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td align="left">2.4- Premiação na área de Artes. 0,50 por cada premiação</td>
                                                        <td>0.00 - 1.00</td>  
                                                    ...
                                                    <tr>
                                                        <td align="left">4.1- Memorial. Apresentação da experiência da(o) candidata(o) na área de Artes e sua relação como campo teórico-metodológico da linha de pesquisa
 pretendidanoPPGArtes </td>
                                                        <td>0.00 - 2.00</td>  
