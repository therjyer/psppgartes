...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $pdf->Cell(5.3, 0.6, 'Orientador', 1, 0, "C");
        //$pdf->Cell(5.3, 0.6, 'retirar', 1, 0, "C");
        $pdf->Cell(2.2, 0.6, 'Linha', 1, 0, "C");
        $pdf->Cell(2.5, 0.6, 'Área', 1, 0, "C");
        $pdf->Cell(2, 0.6, 'Nota Proj', 1, 0, "C");
        $pdf->Cell(2, 0.6, 'Nota Curr', 1, 0, "C");
        $pdf->Cell(2, 0.6, 'Nota Entre', 1, 0, "C");
        $pdf->Cell(2, 0.6, 'Media', 1, 1, "C");
    }
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Cell(2, 0.6, $notaCurriculo, 1, 0, "C");
    $pdf->Cell(2, 0.6, $notaEntrevista, 1, 0, "C");
    $pdf->Cell(2, 0.6, $media, 1, 1, "C");
}
