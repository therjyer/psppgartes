...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        //per�odo da busca
        $periodo = " PROCESSO SELETIVO " . $processo . " - RELATÓRIO DE ORIENTADORES SELECIONADOS PELOS CANDIDATOS  (MESTRADO)";
        $pdf->setXY(1.5, 2);
...
$result = mysqli_query($_SG['link'], "SELECT * FROM `viewcandidatosoptorientadores` WHERE processo = $idProcesso AND tipoProcesso = 1 ORDER BY orientador1");
