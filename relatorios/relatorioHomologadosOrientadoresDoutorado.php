...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        //per�odo da busca
        $periodo = " PROCESSO SELETIVO " . $processo . " - RELATÓRIO DE ORIENTADORES SELECIONADOS PELOS CANDIDATOS (DOUTORADO)";
        $pdf->setXY(1.5, 2);
        ...
        $pdf->Cell(3, 0.6, 'Nº de iscrição', 1, 0, "C");
        $pdf->Cell(6.24, 0.6, 'Orientador sugerido 1', 1, 0, "C");
        $pdf->Cell(6.24, 0.6, 'Orientador sugerido 2', 1, 1, "C");
    }
...
$result = mysqli_query($_SG['link'], "SELECT * FROM `viewcandidatosoptorientadores` WHERE processo = $idProcesso  AND tipoProcesso = 2 ORDER BY orientador1");
...
while ($row = mysqli_fetch_array($result) ) {
    ...
    $Professor1 = $row['orientador1'];
    $Professor2 = $row['orientador2'];
    ...
    $pdf->Cell(6.24, 0.6, $Professor1, 1, 0, "L");
    $pdf->Cell(6.24, 0.6, $Professor2, 1, 1, "L");
}
