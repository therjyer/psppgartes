...
//$processo = $_GET['processo']; 
      ...
      //período da busca
      $periodo= " PROCESSO SELETIVO ".$processo." - PROVA (MESTRADO)";
      $pdf->setXY(1.5, 2);
...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf, c.notaProva1, c.notaProva2, c.notaAnteprojeto1, c.notaAnteprojeto2 FROM candidato c WHERE c.processo = $idProcesso AND (((c.notaAnteprojeto1+c.notaAnteprojeto2)/2)>=7) AND c.estado=1 AND c.tipoProcesso = 1 ORDER BY c.nome");
...
$pdf->Output("relatorioProjetoMest_nome.pdf","I");
