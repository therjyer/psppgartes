...
//$processo = $_GET['processo']; 
      ...
      //período da busca
      $periodo= " PROCESSO SELETIVO ".$processo." - CANDIDATOS CLASSIFICADOS NA ANÁLISE DE CURRÍCULO(DOUTORADO)";
      $pdf->setXY(1.5, 2);
     ...
     $pdf->Cell(4,0.6,'Pontuação',1,1,"C");
...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.pontuacaoCurriculo, c.notaProva1, c.notaProva2 from candidato c WHERE c.processo = $idProcesso AND c.estado=1 AND c.estadoHomologacao = 1 AND c.tipoProcesso=2 AND c.pontuacaoCurriculo > 0 ORDER BY c.nome");
...
$pdf->Output("Candidatos Classificados na Análise de Currículo(Processo Seletivo ".$processo.").pdf","I");
