...
$linha2Er = 2; // 1 vaga - 1 preenchida - 1 n�o classificada, recebe 1 vaga de ac
...
for ($i = 0; $i < $total_results; $i++) {
    ...
    // if ($i == 6) {
   //   $pdf->setX(1); 
   //   $pdf->Cell(27.2, 0.6, 'Do 7� ao 11� LINHAS 02 OU 03 CONFORME ADENDO PUBLICADO EM 13/06/2018', 1, 1, "C");  
   // }
...
$pdf->Output("Relat�rio Geral - MESTRADO (Processo Seletivo " . $processo . ").pdf", "I");
?>