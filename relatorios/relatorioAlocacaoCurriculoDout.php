...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf, c.tipoProcesso, c.notaProva1, c.notaProva2,c.notaEntrevista, c.avaliadorCurriculo1, c.avaliadorCurriculo2 FROM candidato c WHERE c.processo = $idProcesso AND c.estado=1 AND c.estadoHomologacao = 1 AND c.tipoProcesso=2 AND  (((c.notaProva1+c.notaProva2)/2)>=7) ORDER BY c.avaliadorCurriculo1, c.nome");
