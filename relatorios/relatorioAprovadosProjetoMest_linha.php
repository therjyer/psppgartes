...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf,c.linhaPesquisa, c.areaAtuacao, c.notaAnteprojeto1, c.notaAnteprojeto2 FROM candidato c WHERE c.processo = $idProcesso AND c.estadoHomologacao=1 AND c.estado=1 AND (((c.notaAnteprojeto1+c.notaAnteprojeto2)/2)>=7) AND c.tipoProcesso=1 ORDER BY c.linhaPesquisa, c.areaAtuacao, c.nome");
...
for ($i = 0; $i < $total_results; $i++) {
    ...
    $area = mysql_result($result, $i, 'areaAtuacao');
...
$pdf->Output("relatorioAprovadosProjetoMest_linha_area.pdf", "I");
?>
