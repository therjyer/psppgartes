...
//tabela de dados
$result = mysqli_query($_SG['link'], "SELECT c.nome, c.numInscricao, c.cpf,c.linhaPesquisa, c.areaAtuacao, c.pontuacaoCurriculo FROM candidato c WHERE c.processo = $idProcesso AND c.estadoHomologacao=1 AND c.estado=1 AND (((c.notaProva1+c.notaProva2)/2)>=7) AND c.tipoProcesso=1 AND c.pontuacaoCurriculo > 0 ORDER BY c.linhaPesquisa, c.areaAtuacao, c.nome");
...
$pdf->Output("relatorioAprovadosCurrMest_linha.pdf", "I");
?>
