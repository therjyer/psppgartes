...
FROM candidato c WHERE  c.processo = 47 AND c.estadoEntrevista = 1 AND c.estado=1 AND c.tipoProcesso = $idTipoProcesso AND c.estadoCurriculo = 1 AND c.cotas = 'ac' AND c.notaEntrevista >= 7 ORDER BY c.linhaPesquisa, c.colocacao");
...
$result = mysqli_query($_SG['link'], "SELECT  c.idCandidato, c.nome, c.linhaPesquisa,  ((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) AS notaAnteprojeto, c.pontuacaoCurriculo, c.notaEntrevista , c.notaFinal, ((((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) + c.pontuacaoCurriculo + c.notaEntrevista) / 3 ) AS notaFinalCalc, c.colocacao AS colocacao, c.resultadoFinal AS resultadoFinal
FROM candidato c WHERE  c.processo = 47 AND c.estadoEntrevista = 1 AND c.estado=1 AND c.tipoProcesso = $idTipoProcesso AND c.estadoCurriculo = 1 AND c.cotas in ('er') AND c.notaEntrevista >= 7 ORDER BY c.linhaPesquisa, c.colocacao");  //'cc','cct'
...
$result = mysqli_query($_SG['link'], "SELECT  c.idCandidato, c.nome, c.linhaPesquisa,  ((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) AS notaAnteprojeto, c.pontuacaoCurriculo, c.notaEntrevista , c.notaFinal, ((((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) + c.pontuacaoCurriculo + c.notaEntrevista) / 3 ) AS notaFinalCalc, c.colocacao AS colocacao, c.resultadoFinal AS resultadoFinal
FROM candidato c WHERE  c.processo = 47 AND c.estadoEntrevista = 1 AND c.estado=1 AND c.tipoProcesso = $idTipoProcesso AND c.estadoCurriculo = 1 AND c.cotas in ('ct') AND c.notaEntrevista >= 7 ORDER BY c.linhaPesquisa, c.colocacao");
...
$result = mysqli_query($_SG['link'], "SELECT  c.idCandidato, c.nome, c.linhaPesquisa,  ((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) AS notaAnteprojeto, c.pontuacaoCurriculo, c.notaEntrevista , c.notaFinal, ((((c.notaAnteprojeto1+c.notaAnteprojeto2)/2) + c.pontuacaoCurriculo + c.notaEntrevista) / 3 ) AS notaFinalCalc, c.colocacao AS colocacao, c.resultadoFinal AS resultadoFinal
FROM candidato c WHERE  c.processo = 47 AND c.estadoEntrevista = 1 AND c.estado=1 AND c.tipoProcesso = $idTipoProcesso AND c.estadoCurriculo = 1 AND c.cotas in ('padt') AND c.notaEntrevista >= 7 ORDER BY c.linhaPesquisa, c.colocacao");
